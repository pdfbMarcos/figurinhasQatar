...
function SwapScreen({ route }) {
  ...
  async function saveCount() {
    try {
      await AsyncStorage.setItem(teamID + "r", count.toString());
    } catch (error) {
      console.log(error);
    }
  }
  async function getCount() {
    try {
      const valueCount = await AsyncStorage.getItem(teamID + "r");
  ...
  async function saveBtn1() {
    try {
      await AsyncStorage.setItem(
        teamID + "r" + (parseInt("1") + parseInt(counter)),
        btn1Pushed ? "1" : "0"
      );
    } catch (error) {
      console.log(error);
  ...
  async function saveBtn2() {
    try {
      await AsyncStorage.setItem(
        teamID + "r" + (parseInt("2") + parseInt(counter)),
        btn2Pushed ? "1" : "0"
      );
    } catch (error) {
      console.log(error);
  ...
  async function saveBtn3() {
    try {
      await AsyncStorage.setItem(
        teamID + "r" + (parseInt("3") + parseInt(counter)),
        btn3Pushed ? "1" : "0"
      );
    } catch (error) {
      console.log(error);
  ...
  async function saveBtn4() {
    try {
      await AsyncStorage.setItem(
        teamID + "r" + (parseInt("4") + parseInt(counter)),
        btn4Pushed ? "1" : "0"
      );
    } catch (error) {
      console.log(error);
  ...
  async function saveBtn5() {
    try {
      await AsyncStorage.setItem(
        teamID + "r" + (parseInt("5") + parseInt(counter)),
        btn5Pushed ? "1" : "0"
      );
    } catch (error) {
      console.log(error);
  ...
  async function saveBtn6() {
    try {
      await AsyncStorage.setItem(
        teamID + "r" + (parseInt("6") + parseInt(counter)),
        btn6Pushed ? "1" : "0"
      );
    } catch (error) {
      console.log(error);
  ...
  async function saveBtn7() {
    try {
      await AsyncStorage.setItem(
        teamID + "r" + (parseInt("7") + parseInt(counter)),
        btn7Pushed ? "1" : "0"
      );
    } catch (error) {
      console.log(error);
  ...
  async function saveBtn8() {
    let key =
      numBtn === 7 ? "00" : teamID + "r" + (parseInt("8") + parseInt(counter));
    try {
  ...
  async function saveBtn9() {
    try {
      await AsyncStorage.setItem(
        teamID + "r" + (parseInt("9") + parseInt(counter)),
        btn9Pushed ? "1" : "0"
      );
    } catch (error) {
      console.log(error);
  ...
  async function saveBtn10() {
    try {
      await AsyncStorage.setItem(
        teamID + "r" + (parseInt("10") + parseInt(counter)),
        btn10Pushed ? "1" : "0"
      );
    } catch (error) {
      console.log(error);
  ...
  async function saveBtn11() {
    try {
      await AsyncStorage.setItem(
        teamID + "r" + (parseInt("11") + parseInt(counter)),
        btn11Pushed ? "1" : "0"
      );
    } catch (error) {
      console.log(error);
  ...
  async function saveBtn12() {
    try {
      await AsyncStorage.setItem(teamID + "r12", btn12Pushed ? "1" : "0");
    } catch (error) {
      console.log(error);
    }
  }
  async function saveBtn13() {
    try {
      await AsyncStorage.setItem(teamID + "r13", btn13Pushed ? "1" : "0");
    } catch (error) {
      console.log(error);
    }
  }
  async function saveBtn14() {
    try {
      await AsyncStorage.setItem(teamID + "r14", btn14Pushed ? "1" : "0");
    } catch (error) {
      console.log(error);
    }
  }
  async function saveBtn15() {
    try {
      await AsyncStorage.setItem(teamID + "r15", btn15Pushed ? "1" : "0");
    } catch (error) {
      console.log(error);
    }
  }
  async function saveBtn16() {
    try {
      await AsyncStorage.setItem(teamID + "r16", btn16Pushed ? "1" : "0");
    } catch (error) {
      console.log(error);
    }
  }
  async function saveBtn17() {
    try {
      await AsyncStorage.setItem(teamID + "r17", btn17Pushed ? "1" : "0");
    } catch (error) {
      console.log(error);
    }
  }
  async function saveBtn18() {
    try {
      await AsyncStorage.setItem(teamID + "r18", btn18Pushed ? "1" : "0");
    } catch (error) {
      console.log(error);
    }
  }
  async function saveBtn19() {
    try {
      await AsyncStorage.setItem(teamID + "r19", btn19Pushed ? "1" : "0");
    } catch (error) {
      console.log(error);
    }
  }
  async function saveBtn20() {
    try {
      await AsyncStorage.setItem(teamID + "r20", btn20Pushed ? "1" : "0");
    } catch (error) {
      console.log(error);
    }
  }
  ...
  async function getBtn12() {
    try {
      const value = await AsyncStorage.getItem(teamID + "r12");
  ...
  async function getBtn13() {
    try {
      const value = await AsyncStorage.getItem(teamID + "r13");
  ...
  async function getBtn14() {
    try {
      const value = await AsyncStorage.getItem(teamID + "r14");
  ...
  async function getBtn15() {
    try {
      const value = await AsyncStorage.getItem(teamID + "r15");
  ...
  async function getBtn16() {
    try {
      const value = await AsyncStorage.getItem(teamID + "r16");
  ...
  async function getBtn17() {
    try {
      const value = await AsyncStorage.getItem(teamID + "r17");
  ...
  async function getBtn18() {
    try {
      const value = await AsyncStorage.getItem(teamID + "r18");
  ...
  async function getBtn19() {
    try {
      const value = await AsyncStorage.getItem(teamID + "r19");
  ...
  async function getBtn20() {
    try {
      const value = await AsyncStorage.getItem(teamID + "r20");
  ...
  return (
    <Screen style={styles.logoContainer}>
      <Text style={styles.textTitle}>{"** REPETIDAS **"}</Text>
